...
// CREATE A FOR OF LOOP TO LOG THE STRINGS AS SEPARATE LINES
for (const flight of flights.split('+')) {
  // SPLIT THE SINGLE LINE OF STRING INTO AN ARRAY + DESTRUCTURING []
  const [type, from, to, time] = flight.split(';');
  // OUTPUT STRING, PLUS FORMAT THE [type, form, to, time] INDIVIDUALLY
